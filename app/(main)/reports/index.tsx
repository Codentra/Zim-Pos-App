...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 16, fontWeight: "600", color: colors.light.text, marginTop: spacing.lg, marginBottom: spacing.sm },
  card: { backgroundColor: colors.light.surface, padding: spacing.md, borderRadius: borderRadius.md, borderWidth: 1, borderColor: colors.light.border },
  row: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", paddingVertical: spacing.xs },
  rowLabel: { fontSize: 14, color: colors.light.text, flex: 1 },
  rowValue: { fontSize: 14, color: colors.light.textSecondary },
  lowStockValue: { fontSize: 14, color: colors.light.error },
  empty: { fontSize: 14, color: colors.light.textSecondary },
});
